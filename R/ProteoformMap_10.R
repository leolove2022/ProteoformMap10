...
#' @export
ProteoformMap_10 = function(Peptide_FC_P){
  #Peptide_FC_P <- read.xlsx( "~/Documents/Experiment/WeiWei exercise peptide proteomic/Alb_FC_P.xlsx", rowNames = F,colNames = T) # this is simple peptide for test
  Peptide_FC_P[,"selected"]=0 # label all = 0 and add the FC>1.5 as 1 in next### for test
  ...
  #celltype_test<-subset(Peptide_FC_P,selected==1)
